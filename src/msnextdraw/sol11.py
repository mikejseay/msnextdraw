...
class Sol11Drawing:
    ...
    def get_lines_for_quadrant(
        self, quadrant_index: int
    ) -> list[tuple[float, float, float, float]]:
        """
...
Examples:
  ...
  python sol11.py plotter --dry-run  # Preview plotter commands
    ...
    parser.add_argument(
        "mode", choices=["animation", "single", "svg", "plotter"], help="Output mode"
    )
